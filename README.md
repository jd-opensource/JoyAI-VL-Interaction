...
<p>
  ...
  <a href="https://www.jdcloud.com/cn/products/joybuildmaas"><b>☁️ JD Cloud API</b></a>
</p>
...
- **[2026-08-11]** ☁️ JoyAI-VL-Interaction is now available on JD Cloud and can be accessed via API. Get started with [JoyBuilder MaaS](https://www.jdcloud.com/cn/products/joybuildmaas), [get and configure an API key](https://docs.jdcloud.com/cn/jdaip/Get%20API-Key), and follow the [API usage guide](doc/api.md). For platform details, read the [JoyBuilder Model Development Platform 2.0 documentation](https://docs.jdcloud.com/cn/jdaip/preparation). Resources: [GitHub](https://github.com/jd-opensource/JoyAI-VL-Interaction) | [Hugging Face](https://huggingface.co/jdopensource/JoyAI-VL-Interaction).
